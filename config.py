...
SPIKE_FALSE_NEGATIVE_WEIGHT = 2000.0  # Heavy penalty for missing actual spikes (4x increase)
SPIKE_TRUE_NEGATIVE_WEIGHT = 0.05  # Very low weight for correct non-spike predictions (2x decrease)
