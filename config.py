...
SPIKE_FALSE_NEGATIVE_WEIGHT = 1000.0  # Heavy penalty for missing actual spikes (balanced for ensemble)
SPIKE_TRUE_NEGATIVE_WEIGHT = 0.1  # Very low weight for correct non-spike predictions (balanced)
